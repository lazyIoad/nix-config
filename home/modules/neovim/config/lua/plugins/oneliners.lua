...
return {{"nvim-tree/nvim-web-devicons", lazy = true}, {"nvim-lua/plenary.nvim", lazy = true}, {"RRethy/vim-illuminate", event = "VeryLazy"}, {"akinsho/bufferline.nvim", config = true}, {"folke/zen-mode.nvim", cmd = "ZenMode", opts = {window = {backdrop = 1}, plugins = {options = {laststatus = 3}}}}, {"folke/trouble.nvim", event = "VeryLazy", keys = {{"<leader>t", _1_, desc = "Open diagnostics"}}}, {"kylechui/nvim-surround", config = true, version = "*", event = "VeryLazy"}}
